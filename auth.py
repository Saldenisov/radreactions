...
class UserManager:
    ...
    def _create_default_users(self) -> Dict:
        ...
        default_users = {
            "saldenisov": {
                "password": self._hash_password("Elys3!icp123"),
                "email": "",
                "contact_info": {
                    "phone": "",
                    "department": "",
            ...
            "zhiwenjiang": {
                "password": self._hash_password("Elys3!icp321"),
                "email": "",
                "contact_info": {
                    "phone": "",
                    "department": "",
            ...
            "jplarbre": {
                "password": self._hash_password("Elys3!icp132"),
                "email": "",
                "contact_info": {
                    "phone": "",
                    "department": "",
    ...
    def send_registration_request(self, requested_username: str, email: str, justification: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"Registration request sent. Please contact sergey.denisov@universite-paris-saclay.fr for approval."
