import sqlite3
from reactions_db import connect, SCHEMA_SQL, DB_PATH
...
def reset_db():
    ...
    for trig in [
        'reactions_ai', 'reactions_ad', 'reactions_au'
    ]:
        try:
    ...
    for tbl in [
        'measurements', 'reactions_fts', 'reactions', 'references_map', 'schema_migrations'
    ]:
        try:
